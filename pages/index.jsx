...
export default function Index() {
  ...
  return (
    <>
      ...
      <img width="500" src="/img/bck.png" />
       ...
       How about moderating your own server with Brux bot? Create your own free world and create your own playlist, experience this pleasure with the best sounds. 
	  </p>
  ...
  <Link href={"https://discord.com/api/oauth2/authorize?client_id=1125240286663168051&permissions=8&scope=bot"}>
...
Vote Brux</a>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-y-12 lg:gap-y-0 lg:gap-x-12 py-24">
          <div className="col-span-4">
            ...
            <a href="https://discord.gg/MAnUcEKM9M" className={"mt-10 flex items-center px-4 justify-center gap-x-2 shadow-lg shadow-amber-600/20 cursor-pointer rounded-xl py-4 font-medium bg-gradient-to-r from-amber-700 to-amber-500 hover:opacity-80 transition duration-200 text-white"}>
          ...
          <div className="col-span-8 grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div>
                <div className="text-white">
                  ...
                  <p className="text-gray-500 line-clamp-4">With fast and customizable settings specific to your server, brux gives you a musical pleasure to the fullest.</p>
                </div>
              </div>
              <div>
                <div className="text-white">
      ...
      <div className="flex flex-row w-full h-auto lg:h-56 my-14 lg:my-40 bg-gradient-to-br lg:px-30 from-neutral-900/90 flex items-center justify-start to-neutral-900/50 rounded-lg p-1 shadow-md">
              <>
                <div className="lg:mx-4 lg:p-8 py-4 lg:py-16 flex items-center justify-center flex-col text-center w-full lg:w-auto lg:text-left lg:flex-none">
                  <img src="https://cdn.discordapp.com/attachments/1125240286663168051/1125240286663168051/unknown.png"  width="256src="https://cdn.discordapp.com/attachments/1125240286663168051/1125240286663168051/unknown.png" className="lg:hidden rounded-xl mb-5 shadow-xl shadow-black" />
                ...
                <img src="https://cdn.discordapp.com/attachments/1125240286663168051/1125240286663168051/unknown.png" className="hidden lg:block rounded-xl perspective-right shadow-xl shadow-black" />
              </>
